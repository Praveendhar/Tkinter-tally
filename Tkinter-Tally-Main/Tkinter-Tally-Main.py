...
def chartofaccountsgroups():
    ...
    global Canvas4
    Canvas4 = tk.Canvas(background="#e6ffff", insertbackground="black", relief="ridge",selectbackground="blue", selectforeground="white").place(relx=0.850, rely=0.07, relheight=0.9, relwidth=0.150)


    Label1 = Label(Canvas2,text='List of Groups', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0, rely=0.07,relwidth=.100)
    ...
    b5 = Button(Canvas2,text = "Bank Accounts",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGbankaccounts).place(relx=0.02, rely=0.24)
    b6 = Button(Canvas2,text = "Cash in Hand",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGcashinhand).place(relx=0.02, rely=0.27)
    b7 = Button(Canvas2,text = "Deposits (Asset)",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGdeposits).place(relx=0.02, rely=0.30)
    b8 = Button(Canvas2,text = "Loans & Advances (Asset)",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGloansandadvances).place(relx=0.02, rely=0.33)
    b9 = Button(Canvas2,text = "Stock-in-Hand",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGstockinhand).place(relx=0.02, rely=0.36)
    b10 = Button(Canvas2,text = "Sundry Debtors",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGsundrydebtors).place(relx=0.02, rely=0.39)
    b11 = Button(Canvas2,text = "Current Liabilities",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGcurrentliabilities).place(relx=0, rely=0.42)
    b12 = Button(Canvas2,text = "Duties & Taxes",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGdutiesandtaxes).place(relx=0.02, rely=0.45)
    b13 = Button(Canvas2,text = "Provisions",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGprovisions).place(relx=0.02, rely=0.48)
    b14 = Button(Canvas2,text = "Sundry Creditors",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGsundrycreditors).place(relx=0.02, rely=0.51)
    b15 = Button(Canvas2,text = "Direct Expenses",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGdirectexpenses).place(relx=0, rely=0.54)
    b16 = Button(Canvas2,text = "Direct Incomes",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGdirectincomes).place(relx=0, rely=0.57)
    b17 = Button(Canvas2,text = "Fixed Assets",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGfixedassets).place(relx=0, rely=0.60)
    b18 = Button(Canvas2,text = "Inderect Expenses",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGindirectexpenses).place(relx=0, rely=0.63)
    b19 = Button(Canvas2,text = "Inderect Incomes",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGindirectincomes).place(relx=0, rely=0.66)
    b20 = Button(Canvas2,text = "Investments",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGinvestments).place(relx=0, rely=0.69)
    b21 = Button(Canvas2,text = "Loans (Liability)",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGloans).place(relx=0, rely=0.72)
    b22 = Button(Canvas2,text = "Bank OD A/c",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGbankodaccount).place(relx=0.02, rely=0.75)
    b23 = Button(Canvas2,text = "Secured Loans",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGsecuredloans).place(relx=0.02, rely=0.78)
    b24 = Button(Canvas2,text = "Unsecured Loans",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGunsecuredloans).place(relx=0.02, rely=0.81)
    b25 = Button(Canvas2,text = "Misc Expenses (ASSET)",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGmiscexpenses).place(relx=0, rely=0.84)
    b26 = Button(Canvas2,text = "Purchase Accounts",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGpurchaseaccounts).place(relx=0, rely=0.87)
    b27 = Button(Canvas2,text = "Sales Accounts",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGsalesaccounts).place(relx=0, rely=0.90)
    b28 = Button(Canvas2,text = "Suspense A/c",activeforeground = "black", activebackground = "#ffbe23",fg='black',bg='white',borderwidth=0,font=('Arial 10'),command=LOGsuspenseaccount).place(relx=0, rely=0.93)
    back = Button(Canvas4,text = "Back",activeforeground = "white", activebackground = "black",fg='black',bg='white',borderwidth=1,font=('Arial 10'),command=chartofaccounts).place(relx=0.9, rely=0.1)
...
def LOGbranchordivision():
    ...
    back = Button(Canvas4,text = "Back",activeforeground = "white", activebackground = "black",fg='black',bg='white',borderwidth=1,font=('Arial 10'),command=chartofaccountsgroups).place(relx=0.9, rely=0.1)
...
def LOGbankaccounts():
    ...
    Label1 = Label(Canvas3,text='Bank Accounts', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    Label4 = Label(Canvas3,text='Under :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.18)
    Label5 = Label(Canvas3,text='Current Assets', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.10, rely=0.18)
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
...
def LOGcashinhand():
    ...
    Label1 = Label(Canvas3,text='Cash in Hand', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGdeposits():
    ...
    Label1 = Label(Canvas3,text='Deposits', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGloansandadvances():
    ...
    Label1 = Label(Canvas3,text='Loans and Advances', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGstockinhand():
    ...
    Label1 = Label(Canvas3,text='Stock-in-Hand', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGsundrydebtors():
    ...
    Label1 = Label(Canvas3,text='Sundry Debtors', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGcurrentliabilities():
    ...
    Label1 = Label(Canvas3,text='Current Liabilities', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGdutiesandtaxes():
    ...
    Label1 = Label(Canvas3,text='Duties & Taxes', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    Label4 = Label(Canvas3,text='Under :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.18)
    Label5 = Label(Canvas3,text='Current Liabilities', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.10, rely=0.18)
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
...
def LOGprovisions():
    ...
    Label1 = Label(Canvas3,text='Provisions', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGsundrycreditors():
    ...
    Label1 = Label(Canvas3,text='Sundry Creditors', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGdirectexpenses():
    ...
    Label1 = Label(Canvas3,text='Direct Expenses', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    ...
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label6 = Label(Canvas3,text='Nature of Group :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.26)
    Labels14 = Label(Canvas3,text='Expenses', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.26)
    Label15 = Label(Canvas3,text='Does it affect gross profits :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.03, rely=0.28)
    Labels16 = Label(Canvas3,text='Yes', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.28)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
    combo3 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.36)
...
def LOGdirectincomes():
    ...
    Label1 = Label(Canvas3,text='Direct Incomes', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    ...
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label6 = Label(Canvas3,text='Nature of Group :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.26)
    Labels14 = Label(Canvas3,text='Income', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.26)
    Label15 = Label(Canvas3,text='Does it affect gross profits :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.03, rely=0.28)
    Labels16 = Label(Canvas3,text='Yes', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.28)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
...
def LOGfixedassets():
    ...
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label6 = Label(Canvas3,text='Nature of Group :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.26)
    Labels14 = Label(Canvas3,text='Assets', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.26)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
    combo3 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.36)
...
def LOGindirectexpenses():
    ...
    Label1 = Label(Canvas3,text='Indirect Expenses', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    ...
    Labels14 = Label(Canvas3,text='Expenses', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.26)
    Label15 = Label(Canvas3,text='Does it affect gross profits :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.03, rely=0.28)
    Labels16 = Label(Canvas3,text='No', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.25, rely=0.28)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
    combo3 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.36)
...
def LOGindirectincomes():
    ...
    Label1 = Label(Canvas3,text='Indirect Incomes', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGinvestments():
    ...
    Label1 = Label(Canvas3,text='Investments', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGloans():
    ...
    Label1 = Label(Canvas3,text='Loans (Liabilities)', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGbankodaccount():
    ...
    Label1 = Label(Canvas3,text='Bank OD A/c', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
    Label4 = Label(Canvas3,text='Under :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.18)
    Label5 = Label(Canvas3,text='Loans (Liability)', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.10, rely=0.18)
    separator = ttk.Separator(Canvas3, orient='horizontal').place(relx=0, rely=0.23, relheight=0, relwidth=0.450)
    Label7 = Label(Canvas3,text='Group behaves like a sub-ledger :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.31)
    combo2 = ttk.Combobox(Canvas3,values=["Yes", "No"]).place(relx=0.25, rely=0.31)
    Label8 = Label(Canvas3,text='Nett Debit/Credit Balances for Reporting :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.36)
...
def LOGsecuredloans():
    ...
    Label1 = Label(Canvas3,text='Secured Loans', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGunsecuredloans():
    ...
    Label1 = Label(Canvas3,text='Unsecured Loans', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGmiscexpenses():
    ...
    Label1 = Label(Canvas3,text='Misc. Expenses (ASSET)', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGpurchaseaccounts():
    ...
    Label1 = Label(Canvas3,text='Purchase Accounts', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGsalesaccounts():
    ...
    Label1 = Label(Canvas3,text='Sales Accounts', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
...
def LOGsuspenseaccount():
    ...
    Label1 = Label(Canvas3,text='Suspense Account', background="white",foreground="black",font="-family {Segoe Arial} -size 15 -weight bold ").place(relx=0.02, rely=0.07)
    Label2 = Label(Canvas3,text='Name :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.11)
    e1=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.11,relwidth=.180)
    Label3 = Label(Canvas3,text='(alias) :', background="white",foreground="black",font="-family {Arial} -size 10 -weight bold ").place(relx=0.02, rely=0.14)
    e2=Entry(Canvas3,bg='#ffdd90').place(relx=0.10,rely=0.14,relwidth=.180)
